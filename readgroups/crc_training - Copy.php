...
<td>
<button type="button" name="view" id="<?php echo $row['Id']; ?>" class="btn btn-success view"><i class="fa fa-eye" aria-hidden="true"></i></button>&nbsp;
<button type="button" name="update"  id="<?php echo $row['Id']; ?>" class="btn btn-primary update"><i class="fa fa-pencil-square" aria-hidden="true"></i>
</button>&nbsp;
<button type="button" name="delete" id="<?php echo $row['Id']; ?>" class="btn btn-danger delete"><i class="fa fa-trash" aria-hidden="true"></i></button></td>		
<?php
}
?>				
</tbody>
