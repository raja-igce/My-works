    ...
    <div class="row">
      <div class="col-md-3 col-sm-4">
        <ul class="usernavdash">
          ...
          <li class="active"><a href="myactivate.php"><i class="fa fa-laptop" aria-hidden="true"></i> My Active Ads</a></li>
...
$query = "SELECT * FROM post_ads where user_id = '$u_id' and ad_status ='2' and ads_delete = '1' ORDER BY id DESC";
