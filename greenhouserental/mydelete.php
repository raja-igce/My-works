    ...
    <div class="row">
      <div class="col-md-3 col-sm-4">
        <ul class="usernavdash">
		  ...
		  <li class="active"><a href="mydelete.php"><i class="fa fa-trash" aria-hidden="true"></i> My Expired Ads</a></li>
 ...
 Received Messages</a></li>
      ...
      <div class="col-md-9 col-sm-8">
       ...
       <!-- <div class="instoretxt">
        ...
        <div class="myads">
          <h3>My Deleted Ads</h3>
          <ul class="searchList" id="gallery_1">
            <!-- ad start -->
<?php			
$u_id =$_SESSION['user_id'];
$query = "SELECT * FROM post_ads where user_id = '$u_id' and ad_status ='2' and ads_delete = '2' ORDER BY id DESC";
                  ...
                  <div class="jobinfo">
                    <div class="row">
                      <div class="col-md-8 col-sm-7">
                        ...
                        <div class="listbtn"><a href="ads_details.php?id=<?php echo urlencode(base64_encode($row['id'])); ?>">View Details</a> <!--<span class="btn btn-danger">Remaining <?php echo 30 - $a; ?> days</span>--><a href="#" class="hpass" data-fullText="<?php echo $row['id'];?>">Repost Ads</a> <a href="#" class="delete_button" id="delete_button" data-fullText = "<?php echo $row['id']; ?>"><span class="glyphicon glyphicon-trash"></span> Delete Ad</a></div>
                      </div>
