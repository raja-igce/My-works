    ...
    <div class="row">
      <div class="col-md-3 col-sm-4">
        <ul class="usernavdash">
          ...
          <li class="active"><a href="received_message.php"><i class="fa fa-envelope-open-o" aria-hidden="true"></i>
...
$query = "SELECT DISTINCT ads_id, user_id FROM client_msg WHERE adspost_id = '$u_id'";
...
$query = "SELECT * FROM post_ads WHERE user_id = '$user_id' ORDER BY id DESC";
			$result2 = mysqli_query($db->con, $query);
			$row2 = mysqli_fetch_assoc($result2);		
			$rec_name = $row2['user_name'];
                            ...
                            <div class="col-xs-10 col-md-10">
                                <div>
                                   <p class="ads_msg_h"> <a href="view_message.php?msg=<?php echo urlencode(base64_encode($ads_id)); ?>">
                                    ...
                                    <div class="mic-info">
                                        By: <a href="#"><span class="badge"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;<?php echo $rec_name; ?></span></a> on <?php echo date("d/m/y h:i:a", strtotime($row['post_date'])); ?>
                                    </div>
                                </div>
