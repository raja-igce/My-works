...
<?php	
$query = "SELECT *FROM dashboard_ads limit 1";
$result = mysqli_query($db->con, $query);
$data1 = mysqli_fetch_assoc($result);
 
?>		
		
        <div class="adimages"> <img src="admin/dashboardimage/<?php echo $data1['ban_ads']; ?>" alt="google ad"> </div>
      </div>
...
$query = "SELECT * FROM post_ads where user_id = '$u_id' ORDER BY id DESC";
			$result = mysqli_query($db->con, $query);
                  ...
                  <div class="jobinfo">
                    <div class="row">
                      <div class="col-md-8 col-sm-7">
                        ...
                        <div class="listbtn"><a href="ads_details.php?id=<?php echo urlencode(base64_encode($row['id'])); ?>">View Details</a> <span class="btn btn-danger">Remaining <?php echo 30 - $a; ?> days</span></div>
                      </div>
                      <div class="col-md-4 col-sm-5 text-right">
                        <div class="adprice"><i class="fa fa-inr" aria-hidden="true"></i>&nbsp;
 <?php echo $row['ad_price']; ?></div>
