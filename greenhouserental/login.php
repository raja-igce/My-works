...
if(isset($session)){
	...
	$data['image'] = $image;
	if($user_obj->fb_login($data)){header('Location: index.php');}
...
if ($client->getAccessToken()) {
	...
	try {
		...
		if($user_obj->google_login($user))
		{
		header('Location: dashboard.php');	
		}
		else
		{
		header('Location: userlogin.php?er='.urlencode(base64_encode(usblock)));	
		}
		...
		//else header('Location: userlogin.php?er='.urlencode(base64_encode(usblock)));
